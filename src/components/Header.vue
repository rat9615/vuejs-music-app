<template>
  <div
    class="flex flex-col items-center justify-center max-h-screen lg:h-56 xl:h-64  lg:py-56 xl:py-64 text-orange-400 bg-gradient-to-r from-black to-gray-900 shadow-2xl"
  >
    <div class="flex flex-row">
      ...
      <h1 class="text-6xl font-extrabold">BāJā Music App</h1>
    </div>
    <div class="italic text-lg">Music app for native music and radio</div>
  </div>
</template>
